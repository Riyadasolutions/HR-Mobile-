...
import 'package:base_app/features/common/presentation/sheets/nationality_picker/nationality_picker_sheet.dart';
...
class NationalitiesSelectorWidget extends StatelessWidget {
  final _tag = 'NationalitiesSelectorWidget';
  ...
  const NationalitiesSelectorWidget({super.key,
  ...
  Widget build(BuildContext context) {
    return CustomButtonArrow(
        ...
        label: _title??tr(LocaleKeys.nationality),
        hint: _hint?? _title??tr(LocaleKeys.nationality),
  ...
  Future<void> _onPressed(
    ...
    var result = await showNationalityPicker(
      context,
