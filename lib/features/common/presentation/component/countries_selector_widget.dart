...
class CountriesSelectorWidget extends StatelessWidget {
  final _tag = 'CountriesSelectorWidget';
  ...
  const CountriesSelectorWidget({super.key,
  ...
  Widget build(BuildContext context) {
    return CustomButtonArrow(
        ...
        label: _title/*??tr(LocaleKeys.country)*/,
        hint: _hint?? _title??tr(LocaleKeys.country),
