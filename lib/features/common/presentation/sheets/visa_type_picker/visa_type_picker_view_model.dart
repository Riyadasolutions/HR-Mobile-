...
class VisaTypePickerViewModel with ChangeNotifier {
  final tag = 'VisaTypePickerViewModel';

  final GetVisaTypesUseCase _getVisaTypesUseCase;
  VisaTypePickerViewModel({
    required GetVisaTypesUseCase getVisaTypesUseCase,
  }) : _getVisaTypesUseCase = getVisaTypesUseCase;
  ...
  Future<void> getList({required bool reload}) async {
    ...
    _responseModel = await _getVisaTypesUseCase.call();
