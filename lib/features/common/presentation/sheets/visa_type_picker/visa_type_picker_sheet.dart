...
class _VisaTypePickerSheet extends StatefulWidget {
  final List<DropDownEntity> _defaultList;
  final DropDownEntity? _defaultValue;
  final bool _isMultiChoice;
  final bool _addAll;
  const _VisaTypePickerSheet({required List<DropDownEntity> defaultList,
  ...
  @override
  State<_VisaTypePickerSheet> createState() => __VisaTypePickerSheetState();


}

class __VisaTypePickerSheetState extends State<_VisaTypePickerSheet> {
  late VisaTypePickerViewModel _viewModel;

  @override
  void initState() {
    super.initState();

    _viewModel = Provider.of<VisaTypePickerViewModel>(context, listen: false);
  ...
  Widget build(BuildContext context) {
    ...
    var responseModel = context.watch<VisaTypePickerViewModel>().responseModel;
    var selectedList = context.watch<VisaTypePickerViewModel>().selectedList;
    var selected = context.watch<VisaTypePickerViewModel>().selected;
    ...
    return CustomSheetContainerView(
      ...
      child: Column(
          ...
          children: <Widget>[
            ...
            CustomSheetHeader(onCancelPress: ()=>NavigationService.goBack(), title: tr(LocaleKeys.visaType)),
...
Future<dynamic> showVisaTypePicker(BuildContext context,
