  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Stack(
        children: <Widget>[
          Container(
            decoration: BoxDecoration(image: dialogBackgroundImage==null?null:DecorationImage(fit: BoxFit.fill,image: AssetImage(dialogBackgroundImage!),)),
            ...
            child: Material(
              ...
              elevation: dialogBackgroundImage==null?0.5:0,
              ...
              child: Padding(
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: <Widget>[
                      SizedBox(height: header != null ? 50.0 : bodyHeaderDistance),
                      body ??
                          Column(
                            mainAxisSize: MainAxisSize.min,
                            children: <Widget>[
          ...
          if (showCloseIcon!)
            Positioned(
              right: 50.0,
              top: dialogBackgroundImage==null?75.0:30,
