...
import 'package:base_app/base/presentation/dialog/base/awesome/awesome_dialog.dart';
...
Future<dynamic> showQuestionDialog(
  ...
  final dialog = AwesomeDialog(
    ...
    descTextStyle: const TextStyle().liteStyle(),
...
void showCustomDialog(BuildContext context, Widget body, {Color? backgroundColor,String? backgroundImage,Widget? closeIcon,Widget? header,required Function onDismissCallback, bool isCancellable = false}) {
  AwesomeDialog(
