...
class SideMenu extends StatefulWidget {
  ...
  SideMenuState createState() {
    switch(type){
      case SideMenuType.shrikNRotate: return ShrinkSlideRotateSideMenuState();
      case SideMenuType.shrinkNSlide: return ShrinkSlideSideMenuState();
      case SideMenuType.slideNRotate: return SlideRotateSideMenuState();
      case SideMenuType.slide: return SlideSideMenuState();
      default:return SlideSideMenuState();
    }
...
abstract class SideMenuState extends State<SideMenu> {
  ...
  Widget _getLogo(double statusBarHeight) {
    return widget.closeIcon != null
        ? Positioned(
            top: statusBarHeight,
            left: widget.inverse ? 0 : null,
            right: widget.inverse ? null : 0,
