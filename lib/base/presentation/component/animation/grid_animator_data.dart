...
class CustomGridAnimatorData extends StatefulWidget {
  final int? itemCount;
  final int? duration;
  final double height;
  final double width;
  ...
  const CustomGridAnimatorData({
    ...
    this.height=127,
    this.width=172,
    this.horizontalSpace =kFormPaddingHorizontal,
    this.verticalSpace =kFormPaddingVertical,
    this.crossAxisSpacing =kFormPaddingHorizontal,
    this.mainAxisSpacing =kFormPaddingHorizontal,
    this.padding,
    this.physics,
  ...
  @override
  _CustomGridAnimatorDataState createState() => _CustomGridAnimatorDataState();
}

class _CustomGridAnimatorDataState extends State<CustomGridAnimatorData> {
