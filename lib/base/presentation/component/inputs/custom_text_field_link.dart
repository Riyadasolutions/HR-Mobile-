  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: [
        ...
        //     child: CustomSVGIcon(iconSVG!,width: 20.r,),
        //   ),
        // ),
        Expanded(
          child: CustomCard(
            child: CustomTextField(
              ...
              icon: icon,
              prefixIcon: iconData,
              prefixWidget:prefixWidget??(iconSVG==null?null: SizedBox(height: 30.r,width: 30.r,child: Center(child:CustomInputIcon(iconSVG!  )))),
