import 'package:base_app/core/custom_calender/models/models.dart';
...
class CalendarDatePicker2WithActionButtons extends StatefulWidget {
  ...
  /// Called when the user wont to reset selected dates
...
class _CalendarDatePicker2WithActionButtonsState
  ...
  _onValueChanged(List<DateTime?> values) {
    _editCache = values;
    DateTime? from = values.isEmpty ? null : values.first!;
    DateTime? to = values.length <= 1 ? null : values[1]!;
      ...
      children: [
        MediaQuery.removePadding(
          ...
          child: CalendarDatePicker2(
            ...
            onValueChanged: (values) =>_onValueChanged(values),
